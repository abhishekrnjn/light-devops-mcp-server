...
class Settings:
    ...
    DESCOPE_ENABLE_DEBUG: bool = (
        os.getenv("DESCOPE_ENABLE_DEBUG", "false").lower() == "true"
    )
    DESCOPE_AUDIENCE: Optional[str] = os.getenv("DESCOPE_AUDIENCE")

    # Auth - development-friendly defaults
    AUTH_ALLOW_ANONYMOUS: bool = (
        os.getenv("AUTH_ALLOW_ANONYMOUS", "false").lower() == "true"
    )
    ...
    DATADOG_API_KEY: Optional[str] = os.getenv("DATADOG_API_KEY") or os.getenv(
        "DD_API_KEY"
    )
    DATADOG_APP_KEY: Optional[str] = os.getenv("DATADOG_APP_KEY") or os.getenv(
        "DD_APP_KEY"
    )
