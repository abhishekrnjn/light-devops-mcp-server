...
class DeployService:
    ...
    async def deploy(
        ...
        deployment, http_status, json_response = await self.client.deploy_service(
    ...
    async def get_recent_deployments(
        self,
    ) -> Tuple[list[Deployment], int, Dict[str, Any]]:
        ...
        json_response["message"] = (
            f"Retrieved {len(successful_deployments)} successful deployments"
        )
